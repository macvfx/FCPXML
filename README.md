...
Found bundle: /path/to/MyProject.fcpxmld
  Inner FCPXML: /path/to/MyProject.fcpxmld/MyProject.fcpxml
...
Why this exists: Older tools, cross-platform workflows, and XML parsers often expect plain  .fcpxml  files, not Apple bundles.
